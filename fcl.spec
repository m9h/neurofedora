...
%build
# CMake 4.x (F44) requires cmake_minimum_required >= 3.5. Same pattern as
# flann; fcl 0.7.0 has the old required-version pin.
%cmake \
...
%changelog
* Wed May 20 2026 Morgan Hough <morgan.hough@gmail.com> - 0.7.0-10
- Revive from Fedora orphan state (was dropped after F42, August 2025).
- Add -DCMAKE_POLICY_VERSION_MINIMUM=3.5 for F44 cmake 4.x compat.
- Final prerequisite of the urdfdom-headers / urdfdom / flann / fcl
  chain that DART 6.16.7 needs.
