...
Source: https://github.com/DCMTK/dcmtk/archive/refs/tags/DCMTK-%{version}.tar.gz#/dcmtk-%{version}.tar.gz
...
# Increase sleep in tests (updated for 3.7.0 OFStandard::forceSleep API)
# https://forum.dcmtk.org/viewtopic.php?t=5084
Patch:      0001-Increase-sleep-for-tests-3.7.0.patch

# place in correct locations
Patch:      0002-chore-undo-changes-to-standard-dirs-3.7.0.patch
...
%prep
%autosetup -n %{name}-DCMTK-%{version} -p1 -S git
...
%changelog
* Fri Mar 13 2026 Morgan Hough <mhough@fedoraproject.org> - 3.7.0-1
- Update to 3.7.0
- ABI version bump to 20
- Update patches for 3.7.0 (dcmtls tests now use OFStandard::forceSleep)
...
* Wed Feb 13 2013 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.0-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_19_Mass_Rebuild

* Wed Aug 01 2012 Jon Ciesla <limburgher@gmail.com> - 3.6.0-12
- FTBFS, BZ 819236.

* Wed Jul 18 2012 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.0-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Tue Feb 28 2012 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.0-10
- Rebuilt for c++ ABI breakage

* Fri Jan 13 2012 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.0-9
